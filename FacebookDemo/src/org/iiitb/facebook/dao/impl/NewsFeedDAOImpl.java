...
//		}
	...
	public static String profileCPicPath(String userId){
		String picPath=StringUtils.RetrivePhotoPath;
		Connection conn = ConnectionPool.getConnection();
		PreparedStatement preStmt;
		String profilePic="";
	...
	public ArrayList<Like> getAllMutualFriends(String userId1,String userId2){
		Connection conn = ConnectionPool.getConnection();
		PreparedStatement preStmt;
		
		ArrayList<Like> likeList=new ArrayList<Like>();
		Like l=null;
		String sql="select * from user where user_id In(select user_id1 from user_friends where  user_id2=? and user_id1 In(select user_id2 from user_friends where user_id1=?));";
		try
		{	
	...
	public static  ArrayList<User> getQ1Detail(String userId){
		Connection conn = ConnectionPool.getConnection();
		PreparedStatement preStmt;
		...
		{	
			...
			while(rs.next()){
				...
				u.setProfilePic(profileCPicPath(u.getUserId()));
				u.setEmail(rs.getString("email_id"));
				u.setFirstName(rs.getString("first_name"));
				u.setMutualCount(getQ1TtempDetail(u.getUserId(), userId));
				ulist.add(u);
			}
		}
		catch (SQLException e)
	...
	public static  int getQ1TtempDetail(String userId1,String userId2){
		Connection conn = ConnectionPool.getConnection();
		PreparedStatement preStmt;
		String sql = "select count(distinct user_id1) from user_friends where  user_id2=? and user_id1 In(select user_id2 from user_friends where user_id1=?)";
		boolean flag=false;
		ArrayList<User> ulist=new ArrayList<User>();
		User u=null;
		int count=0;
